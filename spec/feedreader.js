    ...
    */
        ...
        it("urls are defined and not empty", function() {
          for (var key in allFeeds) {
            if (allFeeds.hasOwnProperty(key)) {
             ...
             expect(allFeeds[key].url).toBeNonEmptyString();
            }
          }
        });
         ...
         it("names are defined and not empty", function() {
           for (var key in allFeeds) {
             if (allFeeds.hasOwnProperty(key)) {
              ...
              expect(allFeeds[key].name).toBeNonEmptyString();
             }
           }
         });
    });
    ...
    describe("The menu", function(){
       ...
       */
       it("menu element is hidden by default", function(){
         ...
         expect(DOMbody).toHaveClass("menu-hidden");
       });
        ...
        function(){
          ...
          $('.menu-icon-link').trigger('click');
            expect(DOMbody).not.toHaveClass("menu-hidden");
         //click second time
          $('.menu-icon-link').trigger('click');
          expect(DOMbody).toHaveClass("menu-hidden");
    ...
    describe("Initial Entries", function(){
      ...
      beforeEach (function(done) {
        loadFeed(0, done);
        resCount = document.querySelectorAll('.tpl-entry').length;
      });
          it("there is at least a single .entry element within the .feed container", function(done) {
            expect(resCount).not.toBe(0);
            done();
          });
    });
